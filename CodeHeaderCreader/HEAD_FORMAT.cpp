...
void HEAD_FORMAT::setInput(std::vector<std::vector<std::string>> input)
{
    this->input = input;
}

void HEAD_FORMAT::setOutput(std::vector<std::vector<std::string>> output)
{
    this->output = output;
}
...
std::vector<std::vector<std::string>> HEAD_FORMAT::getInput() const
{
    return input;
}

std::vector<std::vector<std::string>> HEAD_FORMAT::getOutput() const
{
    return output;
}